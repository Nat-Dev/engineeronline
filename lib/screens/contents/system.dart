...
class _SystemState extends State<System> {
  ...
  Widget build(BuildContext context) {
    List<Widget> contents = [
      ...
      buildChapterButton("งานวิศวกรรมระบบไฟฟ้า สื่อสาร ป้องกันอัคคีภัย"),
      ...
      buildDetail("7.ระบบไฟฟ้าแสงสว่างฉุกเฉินและโคมไฟป้ายทางออกฉุกเฉิน"),
      buildDetail("8.ระบบเสียงประกาศ"),
      buildDetail("9.ระบบเสาอากาศโทรทัศน์รวม"),
      buildDetail("10.ระบบโทรศัพท์ (TELEPHONE SYSTEM)"),
      buildDetail("11.ระบบสัญญาณเรียกพยาบาลแบบไอพี (IP NURSE CALL SYSTEM)"),
      ...
      buildDetail("16.ระบบโทรทัศน์วงจรปิด (CLOSED CIRCUIT TELEVISION SYSTEM)"),
      buildDetail(
      ...
      buildDetail("21.ระบบขจัดละอองน้ำมันและกลิ่นสำหรับปล่องควันในครัว"),
      ...
      buildDetail("17.การขุดกลบร่องที่วางท่อ (EXCAVATION & BACKFILLING)"),
