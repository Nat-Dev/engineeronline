...
class FloorWork extends StatefulWidget {
  @override
  _FloorWorkState createState() => _FloorWorkState();
}

class _FloorWorkState extends State<FloorWork> {
  List<Widget> widgets = [];
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => WebPost("technique_floor_work")));
              },
            ),
            TextButton(
              child: Text("YouTube"),
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => PdfPost("technique_floor_work")));
              },
            )
          ],
        );
