...
class PrecastWork extends StatefulWidget {
  @override
  _PrecastWorkState createState() => _PrecastWorkState();
}

class _PrecastWorkState extends State<PrecastWork> {
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            WebPost("technique_precast_work")));
              },
            ),
            TextButton(
              child: Text("YouTube"),
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            YoutubePost("technique_precast_work")));
              },
            ),
            TextButton(
              child: Text("PDF"),
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            PdfPost("technique_precast_work")));
              },
            )
          ],
        );
