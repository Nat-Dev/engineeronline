...
class ShallowFoundation extends StatefulWidget {
  @override
  _ShallowFoundationState createState() => _ShallowFoundationState();
}

class _ShallowFoundationState extends State<ShallowFoundation> {
  List<Widget> widgets = [];
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            WebPost("technique_shallow_foundation")));
              },
            ),
            TextButton(
              child: Text("YouTube"),
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            YoutubePost("technique_shallow_foundation")));
              },
            ),
            TextButton(
              child: Text("PDF"),
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            PdfPost("technique_shallow_foundation")));
              },
            )
          ],
        );
