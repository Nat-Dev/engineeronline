...
class SoilWork extends StatefulWidget {
  @override
  _SoilWorkState createState() => _SoilWorkState();
}
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => WebPost("technique_soil_work")));
              },
            ),
            TextButton(
              child: Text("YouTube"),
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            YoutubePost("technique_soil_work")));
              },
            ),
            TextButton(
              child: Text("PDF"),
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => PdfPost("technique_soil_work")));
              },
            )
          ],
        );
